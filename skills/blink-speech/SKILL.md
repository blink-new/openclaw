...
```bash
bash scripts/speak.sh "Hello! This is your AI agent speaking." > /data/speech.mp3
```

## Choose a different voice
```bash
bash scripts/speak.sh "Good morning! Here's your daily briefing." nova > /data/briefing.mp3
```
