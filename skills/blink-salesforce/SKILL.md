...
```bash
blink connector exec salesforce /services/data/v62.0/chatter/users/me GET
```

## Search for contacts (SOQL)
```bash
blink connector exec salesforce /services/data/v62.0/query GET \
...
## Create a contact
```bash
blink connector exec salesforce /services/data/v62.0/sobjects/Contact POST '{
  "FirstName": "John",
  "LastName": "Doe",
...
## Update a record
```bash
blink connector exec salesforce /services/data/v62.0/sobjects/Contact/CONTACT_ID PATCH '{
...
```bash
blink connector exec salesforce /services/data/v62.0/sobjects/Opportunity POST '{
...
```bash
blink connector exec salesforce /services/data/v62.0/sobjects/Task POST '{
